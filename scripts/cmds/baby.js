...
module.exports.onChat = async ({ api, event,message }) => {
  try{
    ...
    if(body.startsWith("baby") || body.startsWith("bby") || body.startsWith("jan") || body.startsWith("tar") || body.startsWith("tr") || body.startsWith("bot") || body.startsWith("বট") || body.startsWith("বেবি") ){
